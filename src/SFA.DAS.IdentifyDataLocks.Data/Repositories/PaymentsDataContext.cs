...
{
    public class PaymentsAuditDataContext : DbContext, IPaymentsDataContext
    {
        ...
        public PaymentsAuditDataContext(DbContextOptions<PaymentsAuditDataContext> options) : base(options)
        { }
