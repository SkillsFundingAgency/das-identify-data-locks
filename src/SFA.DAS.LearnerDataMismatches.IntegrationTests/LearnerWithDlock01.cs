...
namespace SFA.DAS.LearnerDataMismatches.IntegrationTests
{
    ...
    public class LearnerWithDlock01
    {
        ...
        public async Task SetUp()
        {
            ...
            var apps = await Testing.AddEntitiesFromJsonResource<ApprenticeshipModel>("SFA.DAS.LearnerDataMismatches.IntegrationTests.TestData.Dlock01_Apprenticeship.json");
            ...
            await Testing.AddEntitiesFromJsonResource<EarningEventModel>("SFA.DAS.LearnerDataMismatches.IntegrationTests.TestData.Dlock01_Earnings.json");

            var dlocks = JsonConvert.DeserializeObject<DataLockEventModel[]>(
                Resources.LoadAsString("SFA.DAS.LearnerDataMismatches.IntegrationTests.TestData.Dlock01_DataLocks.json"));
