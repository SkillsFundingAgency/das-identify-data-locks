...
namespace SFA.DAS.IdentifyDataLocks.IntegrationTests
{
    ...
    public class LearnerWithDlock01
    {
        ...
        public async Task SetUp()
        {
            ...
            var apps = await Testing.AddEntitiesFromJsonResource<ApprenticeshipModel>("SFA.DAS.IdentifyDataLocks.IntegrationTests.TestData.Dlock01_Apprenticeship.json");
            ...
            await Testing.AddEntitiesFromJsonResource<EarningEventModel>("SFA.DAS.IdentifyDataLocks.IntegrationTests.TestData.Dlock01_Earnings.json");
