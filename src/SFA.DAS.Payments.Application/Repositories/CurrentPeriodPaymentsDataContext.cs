...
{
    public class CurrentPeriodPaymentsDataContext : DbContext, ICurrentPeriodPaymentsDataContext
    {
        ...
        public CurrentPeriodPaymentsDataContext(string connectionString)
        {
            this.connectionString = connectionString;
        }

        public CurrentPeriodPaymentsDataContext(DbContextOptions<CurrentPeriodPaymentsDataContext> options)
            : base(options)
        { }
