...
namespace SFA.DAS.Payments.Application.Data.Configurations
{
    ...
    public class PaymentModelConfiguration : IEntityTypeConfiguration<PaymentModel>
    {
        public void Configure(EntityTypeBuilder<PaymentModel> builder)
        {
            ...
            builder.Property(x => x.FundingSourceEventId).HasColumnName(@"FundingSourceEventId");
            ...
            builder.Property(x => x.FundingSource).HasColumnName(@"FundingSource");
            ...
            builder.Property(x => x.ReportingAimFundingLineType).HasColumnName(@"ReportingAimFundingLineType");
        }
    }
}